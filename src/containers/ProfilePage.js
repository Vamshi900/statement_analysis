    ...
    <div className="mx-auto w-11/12 md:w-2/4 py-8 px-4 md:px-8">
      <div className="flex border flex-col items-center md:flex-row md:items-start border-blue-400 px-3 py-4">
        <div
          style={{
            background:
              `url(${photoURL ? photoURL : defaultPhoto})  no-repeat center center`,
        ...
        <div className="md:pl-4">
          <h2 className="text-2xl font-semibold">{displayName ? displayName : 'Vamshi'}</h2>
          <h3 className="italic">{email ? email : 'abcd@gmail.com'}</h3>
        </div>
      </div>
